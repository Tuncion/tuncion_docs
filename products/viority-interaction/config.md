...
-- Basic Settings
ViorityCore.InternalPrefix = 'viority_interaction:' -- The Internal Trigger Prefix | Attention you have to change any integrations in other scripts!
