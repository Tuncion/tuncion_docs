---
description: 🔧 It is absolutely essential to fix Vehicle Color Problems!
---
...
_This fix are for all who have problems with the Vehicle colors e.g. Vehicle colors are not saved_
...
{% code title="GetVehicleProperties" lineNumbers="true" %}
```lua
...
{% code title="SetVehicleProperties" lineNumbers="true" %}
```lua
